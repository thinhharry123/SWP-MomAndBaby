<%-- 
    Document   : updateAccountPersonal
    Created on : Jun 18, 2024, 12:29:13 PM
    Author     : Admin
--%>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal" method="post" action="/SWP391-MomAndBaby/staff/account" enctype="multipart/form-data">
