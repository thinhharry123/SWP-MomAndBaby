                ...
                <section class="panel">
                    ...
                    <c:set var="account" value="${account}"></c:set>
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal" method="post" action="/SWP391-MomAndBaby/admin/account">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="role" class="form-control">
                                            <c:forEach var="role" items="${roles}">
                                                <option value="${role.ID}" ${role.ID == account.role  ? "selected": ""}>${role.name}</option>
                                            </c:forEach>
                                        </select>
                                        </div>
                                    </div>
