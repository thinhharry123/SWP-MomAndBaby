                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="/SWP391-MomAndBaby/admin/category">
        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="table-responsive" style="padding: 5px;">
                    ...
                    <form method="post" action="/SWP391-MomAndBaby/admin/category">
                            ...
                            <tbody class="render-data">
                                <c:forEach items="${categories}" var="category">
                                    <tr>
                                        ...
                                        <td class="box-action">
                                            <a href="/SWP391-MomAndBaby/admin/category/update/${category.ID}" class="btn-action green">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a onclick="return confirm('Are you sure to delete?')" 
                                               href="/SWP391-MomAndBaby/admin/category/delete/${category.ID}" 
