...
<html lang="en">
    ...
    <body class="goto-here">
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="index.html">Mom And Baby</a>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="/SWP391-MomAndBaby" class="nav-link">Home</a></li>
                        <li class="nav-item"><a href="/SWP391-MomAndBaby/blog" class="nav-link">Blog</a></li>
                    </ul>
                </div>
            </div>
        </nav>