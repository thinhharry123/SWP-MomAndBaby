                                ...
                                <c:forEach items="${productsDeal}" var="productDeal">
                                    <div class="product">
                                        ...
                                        <div class="add-to-cart">
                                            ...
                                            <c:if test="${productDeal.quantity == 0}">
                                                <a class="add-to-cart-btn" href="/MomAndBaby/preOrder/add?productID=${productDeal.ID}&pathUrl=/MomAndBaby">
                                ...
                                <c:forEach items="${productsFeature}" var="productFeature">
                                    <div class="product">
                                        ...
                                        <div class="add-to-cart">
                                            ...
                                            <c:if test="${productFeature.quantity == 0}">
                                                <a class="add-to-cart-btn" href="/MomAndBaby/preOrder/add?productID=${productFeature.ID}&pathUrl=/MomAndBaby">
                                                    <i class="fa fa-truck"></i>Pre order
                                                </a>
                                            </c:if>
                                        </div>
                                ...
                                <c:forEach items="${productsNormal}" var="productNormal">
                                    <div class="product">
                                        ...
                                        <div class="add-to-cart">
                                            ...
                                            <c:if test="${productNormal.quantity == 0}">
                                                <a class="add-to-cart-btn" href="/MomAndBaby/preOrder/add?productID=${productNormal.ID}&pathUrl=/MomAndBaby">
                                                    <i class="fa fa-truck"></i> Pre order
                                                </a>
                                            </c:if>
                                        </div>
